...
const KEY_GRID: Record<Hand, Record<Finger, Record<Bank, string>>> = {
  left: {
    pinky: { number: 'Digit1', top: 'KeyQ', home: 'KeyA', bottom: 'KeyZ' },
    ring: { number: 'Digit2', top: 'KeyW', home: 'KeyS', bottom: 'KeyX' },
    middle: { number: 'Digit3', top: 'KeyE', home: 'KeyD', bottom: 'KeyC' },
    index: { number: 'Digit4', top: 'KeyR', home: 'KeyF', bottom: 'KeyV' },
  },
  right: {
    index: { number: 'Digit7', top: 'KeyU', home: 'KeyJ', bottom: 'KeyM' },
    middle: { number: 'Digit8', top: 'KeyI', home: 'KeyK', bottom: 'Comma' },
    ring: { number: 'Digit9', top: 'KeyO', home: 'KeyL', bottom: 'Period' },
    pinky: { number: 'Digit0', top: 'KeyP', home: 'Semicolon', bottom: 'Slash' },
  },
};
...
// 內側鍵:同一根食指內側的各排。用於同手疊放收斂後的強調音符(見 docs/adr/0006)。
const INNER_GRID: Record<Hand, Record<Bank, string>> = {
  left: { number: 'Digit5', top: 'KeyT', home: 'KeyG', bottom: 'KeyB' },
  right: { number: 'Digit6', top: 'KeyY', home: 'KeyH', bottom: 'KeyN' },
};
